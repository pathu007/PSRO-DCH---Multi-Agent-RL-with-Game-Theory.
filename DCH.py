...
flags.DEFINE_integer("n_players", 5, "The number of players.")
...
def gpsro_looper(env, oracle, agents, Player, Level):
  ...
  for gpsro_iteration in range(FLAGS.gpsro_iterations):
    ...
    Pol[Player][Level] = policies
    Meta[Level] = meta_probabilities
